 ...
 */
// From https://github.com/HMS-Core/hms-AREngine-demo/blob/154298691a83df37da7189b4b5b9f073fa773051/HwAREngineDemo/src/main/java/com/huawei/arengine/demos/common/TextureDisplay.java
// IndoorAtlas: package name changed
...
import com.indooratlas.android.sdk.examples.ar.rendering.ShaderUtil;
...
public class TextureDisplay {
    ...
    public void onDrawFrame(ARFrame frame) {
        ...
        // IndoorAtlas: removed extra clear()

        GLES20.glDisable(GLES20.GL_DEPTH_TEST);
        GLES20.glDepthMask(false);

        GLES20.glUseProgram(mProgram);
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0); // IndoorAtlas: added this
