...
@SdkExample(description = R.string.example_imageview_animate_description)
public class ImageViewAnimateActivity extends FragmentActivity {
    ...
    private BlueDotAnimateView mImageView;
    ...
    private IARegion.Listener mRegionListener = new IARegion.Listener() {
        ...
        public void onEnterRegion(IARegion region) {
            if (region.getType() == IARegion.TYPE_FLOOR_PLAN) {
                ...
                Toast.makeText(ImageViewAnimateActivity.this, id, Toast.LENGTH_SHORT).show();
                fetchFloorPlan(id);
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_view_animate);
        // prevent the screen going to sleep while app is on foreground
        findViewById(android.R.id.content).setKeepScreenOn(true);

        mImageView = (BlueDotAnimateView) findViewById(R.id.imageView);
        ...
        ExampleUtils.shareTraceId(findViewById(R.id.imageView), ImageViewAnimateActivity.this,
                mIALocationManager);
                ...
                public void onResult(IAResult<IAFloorPlan> result) {
                    ...
                    if (result.isSuccess() && result.getResult() != null) {
                        ...
                        if (!asyncResult.isCancelled()) {
                            Toast.makeText(ImageViewAnimateActivity.this,
